...
const udacityLogo = DataURI(path.join(__dirname, '../../../img/udacity-logo-transparent.png'))
const googleLogo = DataURI(path.join(__dirname, '../../../img/google-logo-transparent.png'))
